...
image.plot_feature_importances(forest, cancer.data, cancer.feature_names)
plt.title('유방암 데이터로 만든 랜덤 포레스트 모델의 특성 중요도')
image.save_fig("3.cancer_random_forest_feature_importances")  
plt.show()
...
image.plot_feature_importances(gbrt, cancer.data, cancer.feature_names)
plt.title('유방암 데이터로 만든 그래디언트 부스팅 분류기의 특성 중요도')
image.save_fig("3.cancer_GradientBoosting_feature_importances")  
plt.show()

image.plot_feature_importances(gbrtMaxDepth1, cancer.data, cancer.feature_names)
plt.title('유방암 데이터로 만든 그래디언트 부스팅 분류기의 특성 중요도')
image.save_fig("3.cancer_GradientBoosting_MaxDepth1_feature_importances")  
plt.show()

image.plot_feature_importances(gbrtLearningRate001, cancer.data, cancer.feature_names)
plt.title('유방암 데이터로 만든 그래디언트 부스팅 분류기의 특성 중요도')
image.save_fig("3.cancer_GradientBoosting_LearningRate001_feature_importances")  
plt.show()
