...
# 위스콘신 유방암Wisconsin Breast Cancer 데이터셋입니다(줄여서 cancer라고 하겠습니다). 
...
# 사용할 특성의 갯수을 설정
nCase = 30
breast_cancer_dataframe = pd.DataFrame(X_train[:,:nCase], columns=cancer.feature_names[:nCase])
# 데이터프레임을 사용해  특성별 Historgram
breast_cancer_dataframe.plot.hist(alpha=0.5)
...
if nCase <= 10:
    pd.plotting.scatter_matrix(breast_cancer_dataframe, c=y_train, figsize=(15, 15), marker='o',
