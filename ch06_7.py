...
image.save_fig("6.blobs_2class_Scatter")  
plt.show()
...
image.save_fig("6.blobs_linear_svm_Scatter")  
plt.show()
...
image.save_fig("6.blobs_3d_Scatter")  
plt.show()
...
image.save_fig("6.blobs_linear_svm_3d_Scatter")  
plt.show()
...
image.save_fig("6.blobs_linear_svm_3d_decision_function_Scatter")  
plt.show()
